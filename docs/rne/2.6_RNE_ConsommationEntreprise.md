...
- uniquement stock + flux J-1.

### 5.4 Champs absents
Les données suivantes ne sont **pas fournies par RNE** :
- emails,
- téléphones,
...
## 6. Résumé
- `rne_<date>.db.gz` est un snapshot consolidé complet du RNE (stock + flux cumulés jusqu’à J-1).
